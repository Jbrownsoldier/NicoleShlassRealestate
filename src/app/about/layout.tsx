...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "14 years of Toronto real estate experience. Driven by curiosity, fuelled by connection — Nicole Shlass approaches every client relationship with intention and full commitment.",
    url: "https://nicoleshlass.ca/about",
  },
  twitter: {
    title: "About Nicole Shlass — Toronto Sales Representative",
    description:
      "14 years of Toronto real estate experience. Responsive, honest, and genuinely committed to outcomes that align with your lifestyle.",
  },
};
